...
<body>
    ...
    <?php $contador = 1; $totalCantidad = $totalProgramado = $totalAvance = $totalPorcentaje = 0; $observaciones = ''; ?>
    <table class="tableizer-table tableBorder">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center">{{ number_format($item['form_cantidad'],2,',','.') }}</td>
                <td>{{ $item['form_unidad'] }}</td>
            ...
            <?php 
                $totalCantidad = $totalCantidad + (int)$item['form_cantidad']; 
            ...
            <tr>
                ...
                <td align="center"><b>{{ number_format($totalCantidad,2,',','.') }}</b></td>
                <td></td>
    ...
    <div class="tableEspacios">Observaciones : <br>
