    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success box-solid">
                ...
                {!! Form::open(['url' => '/saveAV4', 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            {!! Form::label('form_avance', 'Avance de la Actividad (HA)', ['class' => 'col-md-12 col-xs-12']) !!}
                            <div class="col-md-12 col-xs-12">
                                <div class="input-group">
                                    <div class="input-group-addon">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            {!! Form::label('form_avance2', 'Avance de la Actividad (NR)', ['class' => 'col-md-12 col-xs-12']) !!}
                            <div class="col-md-12 col-xs-12">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-send"></i>
                                    </div>
                                    {!! Form::text('form_avance2', null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
