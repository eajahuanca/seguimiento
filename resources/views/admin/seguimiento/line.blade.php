...
@section('FormularioDescripcion','en esta sección se puede observar el seguimiento del proyecto && programa')
@section('FormularioActual','Proyectos && Programas')
@section('FormularioDetalle','Seguimiento al proyecto && programa')
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="timeline">
                ...
                <li>
                    <i class="fa fa-bars bg-green"></i>
                    <div class="timeline-item">
                        <div class="col-md-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Seguimiento de Proyectos && Programas</h3>
                                    <div class="box-tools pull-right">
                                        <span class="time"><i class="fa fa-clock-o"></i> {{ 'Hora '.date('H:i:s') }}</span>
                                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                        </button>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                            <h4><b>EL PROYECTO AUN NO CUENTA CON SEGUIMIENTO.</b></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
