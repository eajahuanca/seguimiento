...
@section('FormularioDescripcion','modificar datos del Area')
@section('FormularioActual','Area')
@section('FormularioDetalle','Modificar datos del Area')
...
@section('ContenidoPagina')
    ...
    {!! Form::model($area,['route' => ['area.update',$area->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
