...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function importeTotal(){
            var a = parseFloat($("#sol_montofona").val());
            var b = parseFloat($("#sol_montosol").val());
            var c = parseFloat($("#sol_montootro").val());
            if(Number.isNaN(a)) a=0;
            if(Number.isNaN(b)) b=0;
            if(Number.isNaN(c)) c=0;
            $("#btnTotal").empty().html("Importe Total: Bs. " + addCommas(a + b + c));
        }
