                    ...
                    <div class="timeline-item">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Montos y Tiempo</h3>
                                    <div class="box-tools pull-right">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                                            <a href="{{ asset($solicitud->reglamento->reg_archivo) }}">
                                                <img class="margin" src="{{ asset('plugins/login/img/pdf.png') }}" width="90px" height="100px"/>
                                                <h4>{{ $solicitud->reglamento->reg_nombre }}</h4>
                                            </a>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                                            <a href="{{ asset($solicitud->sol_respaldo) }}">
                                                <img class="margin" src="{{ asset('plugins/login/img/pdf.png') }}" width="90px" height="100px"/>
                                                <h4>Respaldo</h4>
                                            </a>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                                            <a href="{{ asset($solicitud->sol_ftecnica) }}">
                                                <img class="margin" src="{{ asset('plugins/login/img/pdf.png') }}" width="90px" height="100px"/>
                                                <h4>Ficha Técnica</h4>
                                            </a>
                                        </div>
...
@section('javascript')
    <script>
        $('#btnEnviar').click(function(){
            window.location.href="{{ route('evaluacion.edit', $solicitud->id) }}";
        });
    </script>
@endsection