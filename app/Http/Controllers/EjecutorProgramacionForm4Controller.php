...
class EjecutorProgramacionForm4Controller extends Controller
{
    private $title;
    private $msg;
    private $estado;
    ...
    public function programacion($idactividad, $idsolicitud){
        ...
        return view('ejecutor.programacion.formulario.formcuatro.index')->with('actividad', $actividad)->with('solicitud', $solicitud);
    }
    ...
    public function guardarProgramacion(Request $request){
        ...
        try{
            ...
            $ejecutor->form_formulario = 'FORMULARIO4';
    ...
    public function avance($idactividad, $idsolicitud, $form){
        ...
        try{
            $actividad = Actividad::find($idactividad);
            $solicitud = Solicitud::find($idsolicitud);
            return view('ejecutor.programacion.formulario.formcuatro.avance')
    ...
    public function guardarAvance(Request $request){
        ...
        try{
            ...
            $porcentaje2 = (100 * $request->form_avance2)/($ejecutor->form_programado2);//pavance2
            $update = DB::table('ejecutorprogramaciones')
                ...
                ->update(
                    [
                        ...
                        'form_avance2' => $request->form_avance2,
                        'form_pavance' => $porcentaje,
                        'form_pavance2' => $porcentaje2,
